...
def multiple_images_handler_beta():
    ...
    if form.validate_on_submit():
        ...
        processor = SingleImageHandler('/Users/haigangliu/Desktop/ML_model_cache/multiclass/multi_class_.pth.tar', 'features.denseblock4.denselayer16.conv2')
